        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            >
              ...
              <p className="text-sm opacity-75 relative z-10">Explore my Clash of Clans inspired skill buildings</p>
          ...
          >
            ...
            <p className="text-lg leading-relaxed mb-4 relative z-10" style={{ fontFamily: "'Kalam', cursive" }}>
              Welcome to my digital playground! This isn't just a portfolio—it's an interactive experience that reflects
              my passion for creative coding and user experience design.
            </p>
            <p className="text-lg leading-relaxed relative z-10" style={{ fontFamily: "'Kalam', cursive" }}>
              Each section tells a story, from the growing skill tree that represents continuous learning to the village
              that showcases my technical abilities. Take your time, explore, and discover the hidden surprises along
              the way.
            </p>
            ...
            <div className="mt-6 text-right relative z-10">
              ...
              >
                Happy coding! ✨<br />
                <span className="text-xs">- The Digital Architect</span>
              </p>
            </div>
          </div>
        </motion.div>
