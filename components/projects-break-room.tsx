  ...
  const projects: Project[] = [
    {
      ...
      description: "A real-time chat app with AI integration",
      longDescription:
        "A sophisticated chat application that integrates multiple AI models for intelligent conversations. Features real-time messaging, context awareness, and beautiful UI animations.",
      technologies: ["Next.js", "TypeScript", "AI SDK", "WebSockets", "Tailwind CSS"],
      features: [
        "Real-time messaging",
    ...
    },
    {
      ...
      longDescription:
        "A comprehensive e-commerce dashboard with real-time analytics, inventory management, and customer insights. Built with modern web technologies for optimal performance.",
      ...
      image: "/placeholder.svg?height=200&width=300&text=E-commerce+Dashboard",
      githubUrl: "https://github.com/example/ecommerce-dashboard",
    },
    {
      id: 3,
      title: "Weather Widget",
      description: "Quick hackathon project",
      longDescription:
        "A beautiful weather widget created during a 48-hour hackathon. Features location-based weather, forecasts, and smooth animations.",
      ...
      demoUrl: "https://weather-widget.example.com",
    },
    {
      id: 4,
      title: "Portfolio Website",
      description: "This very website you're exploring!",
      longDescription:
        "An interactive portfolio website with magical animations, creative storytelling, and immersive user experience. Built to showcase skills and creativity.",
      technologies: ["Next.js", "TypeScript", "Framer Motion", "Tailwind CSS"],
      features: ["Interactive animations", "Creative storytelling", "Responsive design", "Dark mode", "Easter eggs"],
      type: "major",
